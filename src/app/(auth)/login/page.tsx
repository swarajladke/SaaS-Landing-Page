        ...
        <div className="min-h-screen bg-black flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-16 lg:p-24 relative z-10">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-12">
                        <h1 className="text-5xl font-extrabold text-white tracking-tight mb-4">Log In</h1>
            ...
            <div className="hidden md:flex w-1/2 bg-[#050505] items-center justify-center p-12 overflow-hidden relative">
                <div className="grid grid-cols-3 grid-rows-3 gap-6 w-full h-full max-w-4xl max-h-[800px]">
                    ...
                    <div className="rounded-[2.5rem] bg-[#111111]" />
                    <div className="rounded-[2.5rem] bg-indigo-500/20 flex items-center justify-center border border-indigo-500/30">
                        <div className="w-16 h-16 bg-indigo-500 rounded-full blur-2xl opacity-20" />
                    </div>
                    <div className="rounded-[2.5rem] bg-[#111111]" />

                    <div className="rounded-[2.5rem] bg-[#111111] overflow-hidden">
                        <img
                            src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?q=80&w=400&auto=format&fit=crop"
                            alt="Professional Portrait"
                            className="w-full h-full object-cover"
                        />
                    </div>
                ...
                {/* Ambient Overlays */}
                <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-blue-500/10 blur-[150px] -z-10" />
                <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-indigo-500/10 blur-[150px] -z-10" />
            </div>
        </div>
    );
}
